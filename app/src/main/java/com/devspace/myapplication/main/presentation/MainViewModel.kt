...
import com.devspace.myapplication.main.presentation.ui.RecipeMainUiState
...
class MainViewModel(
    ...
    private val _uiRecipes = MutableStateFlow(RecipeMainUiState())
    val uiRecipes: StateFlow<RecipeMainUiState> = _uiRecipes
    ...
    private fun fetchRecipes() {
        _uiRecipes.value = RecipeMainUiState(isLoading = true)
        viewModelScope.launch(Dispatchers.IO) {
            ...
            if (result.isSuccess) {
                ...
                if (recipes != null){
                    ...
                    _uiRecipes.value = RecipeMainUiState(list = recipeUiDataList)
                } else {
                    val ex = result.exceptionOrNull()
                    if (ex is UnknownHostException){
                        _uiRecipes.value = RecipeMainUiState( isError = true,
